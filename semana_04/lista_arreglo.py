...
class ListaArreglo:
    ...
    def eliminar(self, posicion):
        ...
        while contador < self._tamaño - 1:
            self._datos[contador] = self._datos[contador + 1]
            contador += 1
        self._datos[contador] = None
        self._tamaño -= 1
        return eliminado
    ...
    def buscar(self, elemento):
        ...
        contador = 0
        while contador < self._tamaño:
            if self._datos[contador] == elemento:
                return contador
            contador += 1
        return -1
    ...
    def _redimensionar(self, nueva_capacidad):
        ...
        contador = 0
        while contador < self._tamaño:
            datos_nuevos[contador] = self._datos[contador]
            contador += 1
